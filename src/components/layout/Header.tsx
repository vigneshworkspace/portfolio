...
const NavLink = ({ 
    ...
    return (
        <a 
            href={href} 
            className={cn(
                "font-medium tracking-wide relative transition-colors duration-300 responsive-body font-bold",
                isActive ? "text-primary" : "text-foreground/70 hover:text-primary",
            )}
        >
            {children}
            <span className={cn(
                "absolute -bottom-2 left-0 w-full h-1 bg-primary transform transition-transform duration-300",
...
<nav className="flex justify-between items-center h-20">
                    ...
                    <div className="hidden md:flex items-center space-x-16">
                     ...
                     <div className="hidden md:flex items-center gap-10">
                        <ThemeToggleButton />
                        <Button asChild variant="outline" size="sm" className="font-body tracking-wide px-12 py-8 rounded-full responsive-body font-bold">
